              ...
              <Tab.Pane className='row ' eventKey={0}>
                ...
                {virtualGames.length != 0 && (
                  <>
                    ...
                    {virtualGames &&
                      virtualGames.products?.map((game) => {
                        return (
                          <Link
                            key={game.id}
                            to={'/games'}
                ...
                {lotteryGames.length != 0 && (
                  <>
                    ...
                    {lotteryGames &&
                      lotteryGames.products?.map((game) => {
                        return (
                          <Link
                            key={game.id}
                            to={'/games'}
                ...
                {fishingGames.length != 0 && (
                  <>
                    ...
                    {fishingGames &&
                      fishingGames.products?.map((game) => {
                        return (
                          <Link
                            key={game.id}
                            to={'/games'}
                ...
                {fightingGames.length != 0 && (
                  <>
                    ...
                    {fightingGames &&
                      fightingGames.products?.map((game) => {
                        return (
                          <Link
                            key={game.id}
                            to={'/games'}
                ...
                {jackpotGames.length != 0 && (
                  <>
                    ...
                    {jackpotGames &&
                      jackpotGames.products?.map((game) => {
                        return (
                          <Link
                            key={game.id}
                            to={'/games'}
